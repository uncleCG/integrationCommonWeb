...
function getskincookie(){
	...
	$("#skin").attr("href",locat+"/statics/skin/"+v+"/skin.css");
}
...
$(function(){
	...
	/*左侧菜单*/
	//$.Huifold(".menu_dropdown dl.outerDl dt.outerDt",".menu_dropdown dl.outerDl dd.outerDd","fast",1,"click");
	//$.Huifold(".menu_dropdown dl.insideDl dt.insideDt",".menu_dropdown dl.insideDl dd.insideDd","fast",1,"click");
	
	//$(".menu_dropdown dl > dt").click(function(){
		//alert(this.siblings)
		//$(this).parents().children("dd").show();
	//})
	...
	$("#Hui-skin .dropDown-menu a").click(function(){
		...
		setCookie("Huiskin", v);
		$("#skin").attr("href",locat+"/statics/skin/"+v+"/skin.css");
		$(window.frames.document).contents().find("#skin").attr("href",locat+"/statics/skin/"+v+"/skin.css");
	});
//	table自动添加title
	var cellIndex=parseInt($(".table th").length)-1;
	$(".table tr td").each(function(){
         if(this.cellIndex != cellIndex){
        	 var title_text = $(this).text().replace(/[\r\n\t]/g,"");
