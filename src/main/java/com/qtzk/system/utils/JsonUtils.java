...
public class JsonUtils {
	...
	public static String dateToJson(Object obj) {
		if (obj == null) {
			return "";
		} else {
		...
		if (props != null) {
			...
			for (int i = 0; i < props.length; i++) {
				try {
					...
					//logger.debug(props[i].getName() + "###" + props[i].getReadMethod().invoke(bean) + "##" + props[i].getPropertyType());
					json.append(name);
					json.append(":");
					json.append(value);
					json.append(",");
